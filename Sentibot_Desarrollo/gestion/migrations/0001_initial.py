# Generated by Django 5.2.8 on 2025-11-17 14:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sede', models.CharField(default='Melipilla', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Rol',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escuela', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarios', to='gestion.escuela')),
                ('rol', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarios', to='gestion.rol')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(auto_now_add=True)),
                ('sesion', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='encuesta', to='gestion.sesion')),
            ],
        ),
        migrations.CreateModel(
            name='EmocionReal',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fiabilidad', models.FloatField(blank=True, null=True)),
