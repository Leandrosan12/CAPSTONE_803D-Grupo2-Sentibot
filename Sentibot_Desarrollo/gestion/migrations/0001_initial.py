...
>>>>>>> bb3b0de094bcf539b311358677c36a83cff9876e
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escuela', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='usuarios', to='gestion.escuela')),
                ('rol', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='usuarios', to='gestion.rol')),
            ],
            options={
                'verbose_name': 'user',
